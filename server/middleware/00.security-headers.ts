...
export default defineEventHandler((event) => {
    ...
    const csp = [
        ...
        "font-src 'self' data:",
        "connect-src 'self' https://api.olympsis.com https://maps-api.apple.com https://*.apple-mapkit.com https://*.googleapis.com https://*.firebaseio.com https://*.firebaseapp.com https://*.ingest.us.sentry.io https://*.google-analytics.com",
